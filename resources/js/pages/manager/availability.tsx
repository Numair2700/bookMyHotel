            ...
            <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-3">
                <div className="lg:col-span-2">
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                        Set the nightly rate and rooms open on any date.
                    </p>
                ...
                >
                    ...
                    {recentlySuccessful && (
                        <p className="mt-2 rounded-lg bg-eco/10 px-3 py-2 text-sm text-eco">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value={data.rate}
                                    onChange={(e) =>
                                        setData('rate', Number(e.target.value))
                                    }
                                    className={field}
                                />
                                {errors.rate && (
