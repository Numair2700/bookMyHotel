...
const adr = (n: number | null) =>
    n === null
        ? '—'
        : `AED ${n.toLocaleString(undefined, { maximumFractionDigits: 2 })}`;
    ...
    const tiles = [
        {
            ...
            value: summary.room_nights.toLocaleString(),
            icon: BedDouble,
        },
        {
            label: 'Room revenue',
            value: money(summary.room_revenue),
            icon: Coins,
        },
        {
            label: 'Average daily rate',
            value: adr(summary.average_daily_rate),
            icon: TrendingUp,
        },
    ];
