...
export default function Welcome() {
    ...
    const field = 'w-full rounded-lg border border-border bg-background px-3 py-2.5 text-sm text-foreground shadow-sm outline-none transition focus:border-gold focus:ring-2 focus:ring-gold/30';
    const label = 'mb-1.5 block text-xs font-medium tracking-wide text-muted-foreground uppercase';
            ...
            <section className="relative isolate overflow-hidden">
                ...
                <div className="mx-auto max-w-6xl px-4 pt-20 pb-40 sm:px-6 sm:pt-28 lg:pt-32">
                    <p className="flex items-center gap-2 text-sm font-medium tracking-wide text-white/80 uppercase">
                        <Sparkles className="h-4 w-4 text-gold" /> Four five-star chains · Asia &amp; Europe
                    </p>
                    ...
                    <p className="mt-5 max-w-xl text-lg leading-relaxed text-white/85">
                        Search live availability across Marriott, Hilton, Hyatt and Four Seasons — transparent
                        cancellation, and rewards every time you choose a sustainable stay.
                    </p>
                </div>
            </section>
